...
threads = []
for i in xrange(10):
    threads.append(threading.Thread(target=normal_logging))
for t in threads:
    t.start()
for t in threads:
    t.join()
...
threads = []
for i in xrange(10):
    threads.append(threading.Thread(target=better_logging_comp))
for t in threads:
    t.start()
for t in threads:
    t.join()
...
threads = []
for i in xrange(10):
    threads.append(threading.Thread(target=logging_comp))
for t in threads:
    t.start()
for t in threads:
    t.join()
